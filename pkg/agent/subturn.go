...
type ephemeralSessionStoreIface interface {
	...
	ListByPeer(peerID string) []*session.Session
	ListByPrefix(prefix string) []*session.Session
...
func (e *ephemeralSessionStore) GetOrCreate(_ string) *session.Session { return &session.Session{} }
func (e *ephemeralSessionStore) ListByPeer(_ string) []*session.Session   { return nil }
func (e *ephemeralSessionStore) ListByPrefix(_ string) []*session.Session { return nil }
func (e *ephemeralSessionStore) Delete(_ string) error                    { return nil }
